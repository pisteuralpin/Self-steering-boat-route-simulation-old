...
currents_vmax = .7                                                              # Max current speed
...
if ask_for_currents_model: selected_currents_model = lib.menu(currents_models, "Choose currents type :") # Ask for currents model
else: selected_currents_model = 0                                                        # Else, here is the currents model
...
if selected_currents_model == 2:
    ...
    currents_map[:,:,:] = currents_map[:,:,:] / np.max(currents_map[:,:,:]) * currents_vmax  # Normalize currents to currents_vmax
